...
///
/// 详见 [ADR-0009 §2](ADR/0009-ui-architecture-design.md)
@immutable
...
///
/// 详见 [ADR-0009 §4](ADR/0009-ui-architecture-design.md)
...
> 详见 [Interaction-Model.md §2](Interaction-Model.md) + [ADR-0009 §3](ADR/0009-ui-architecture-design.md)
...
///
/// 详见 [Interaction-Model.md §2.1](Interaction-Model.md)
@immutable
...
/// 块间 focus 管理
///
/// 详见 [UI-ARCHITECTURE.md §3.3](UI-ARCHITECTURE.md)
...
- 在 `DocumentElement` 新增 UI 状态字段（[ADR-0009 §2](ADR/0009-ui-architecture-design.md) Hard Rule）
