...
1. revert 对应 PR
2. 恢复 EditorShell 为 StatelessWidget（如 PR #4 回滚）
3. 恢复 EditorTokens 为纯 static const（如 PR #2 回滚）
4. 移除 Markdown 工具栏（如 PR #3 回滚）
...
**本文件由 AI Agent 起草,版本 v1.4（Accepted,架构评审 R3 9.0/10 + R4 架构决策细化 9-10/10 评分后 Accepted）。**
